    ...
    def read_line(self) -> Quote:
        ...
        while quote is None:
            if CommonUtilities.DEBUG:
                ...
                if self.__line_by_line_reader_counter % 10000 == 0:
                    print("Read {} lines in the file.".format(self.__line_by_line_reader_counter))
            if not line:
        ...
        if CommonUtilities.DEBUG:
            ...
            if self.__line_quote_by_quote_reader_counter % 10000 == 0:
                print("Read {} quotes from file.".format(self.__line_quote_by_quote_reader_counter))
        return quote
