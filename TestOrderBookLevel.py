...
class TestOrderBookLevel(TestCase):
    # This code tests the capabilities of the Level Order Book

    def test_constructor(self):
        test_order_book1 = OrderBookOneCcyLevel(EnumClasses.EnumPair.EURUSD)
        test_order_book2 = OrderBookOneCcyLevel()
    ...
    @staticmethod
    def populate_order_book(test_order_book: OrderBookOneCcyLevel = None) -> OrderBookOneCcyLevel:
        book_ccy_pair = EnumClasses.EnumPair.EURJPY

        if test_order_book is None:
            test_order_book = OrderBookOneCcyLevel(book_ccy_pair)
        else:
    ...
    def test_pair(self):
        test_order_book = TestOrderBookLevel.populate_order_book()
        book_ccy_pair = EnumClasses.EnumPair.EURJPY
    ...
    def test_clear_order_book(self):
        ...
        TestOrderBookLevel.populate_order_book(test_order_book)
